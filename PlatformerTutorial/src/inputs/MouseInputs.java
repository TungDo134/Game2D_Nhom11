...
public class MouseInputs implements MouseListener, MouseMotionListener {
	...
	public void mouseMoved(MouseEvent e) {
		switch (Gamestate.state) {
		case MENU -> gamePanel.getGame().getMenu().getMenuController().mouseMoved(e);
	...
	public void mousePressed(MouseEvent e) {
		switch (Gamestate.state) {
		case MENU -> gamePanel.getGame().getMenu().getMenuController().mousePressed(e);
	...
	public void mouseReleased(MouseEvent e) {
		switch (Gamestate.state) {
		case MENU -> gamePanel.getGame().getMenu().getMenuController().mouseReleased(e);
